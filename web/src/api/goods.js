...
const getGoodsByCategory = params => http.get('/goods/category', params)

const getGoodsById = id => http.get(`/goods/${id}`)

export { uploadImage, uploadGoods, updateGoods, getLatestGoods, getGoodsByCategory, getGoodsById }
